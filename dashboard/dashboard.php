...
<body>
    ...
    window.location.href = '../subscription/subs.php';
        ...
        function logout() {
        // Clear session data or any necessary logout process (e.g., removing cookies, tokens)
        // For example, if using sessionStorage or localStorage:
        sessionStorage.removeItem('userLoggedIn'); // Adjust according to your session management method
        localStorage.removeItem('userLoggedIn'); // Or if you're using localStorage
        // Redirect to the index page
        window.location.href = '../index';  // Redirect to the login or homepage
    }
